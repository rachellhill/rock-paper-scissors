...
class Game {
  constructor() {
    ...
    this.winner = null;
    this.winsConditionsClassic = ['rock > scissors', 'scissors > paper', 'paper > rock'];
  }
  playGame() {
  ...
  // if player1's fighter is strictly equal to player2's fighter, return string "its a draw!"
  // if player1's fighter is > player 2s fighter, return player 1 as winner
    // check against wins condition here
  // if player2's
  checkWinner() {
